...
`,j={Wrapper:A.section`
    ...
    `,Background:A.div`
        ...
        &.is-active.move-next {
            animation: ${rr} 1.3s cubic-bezier(0.16, 1, 0.3, 1)
                both;
        }
    ...
    `,AmbientGlow:A.div`
        ...
        animation: ${sr} 8s ease-in-out infinite;
    `,Noise:A.div`
        position: absolute;
        inset: 0;
        opacity: 0.065;
    ...
    `,DeveloperModal:A.div`
        ...
        isolation: isolate;
        animation: ${lr} 560ms cubic-bezier(0.16, 1, 0.3, 1) both;
    ...
    `,LiveRegion:A.span`
        ...
        clip-path: inset(50%);
        white-space: nowrap;
    `},ur=o((e=>{var t=Symbol.for(`react.transitional.element`);function n(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.jsx=n,e.jsxs=n})),M=o(((e,t)=>{t.exports=ur()}))(),dr=`/cinematic-carousel-ui/images/logoBlackBg.png`,fr=7e3,pr=60,mr=[`button`,`a`,`input`,`textarea`,`select`,`[role='button']`].join(`, `),hr=[`a[href]`,`button:not([disabled])`,`input:not([disabled])`,`textarea:not([disabled])`,`select:not([disabled])`,`[tabindex]:not([tabindex="-1"])`].join(`, `),gr=(e,t)=>{var n;return((n=e.find(e=>e.type===t))==null?void 0:n.value)||``},_r=(e,t)=>{let n=new Date(e);if(Number.isNaN(n.getTime()))return null;let r=new Intl.DateTimeFormat(`en-GB`,{timeZone:t,day:`2-digit`,month:`short`,year:`numeric`,hour:`2-digit`,minute:`2-digit`,second:`2-digit`,hourCycle:`h23`}).formatToParts(n),i=gr(r,`day`),a=gr(r,`month`),o=gr(r,`year`);return{year:o,formattedDate:`${i}-${a}-${o} ${gr(r,`hour`)}:${gr(r,`minute`)}:${gr(r,`second`)} hrs (IST)`}},vr=()=>{let[e,t]=(0,_.useState)(!1);return(0,_.useEffect)(()=>{let e=window.matchMedia(`(prefers-reduced-motion: reduce)`),n=()=>{t(e.matches)};return n(),e.addEventListener(`change`,n),()=>{e.removeEventListener(`change`,n)}},[]),e},yr=({onPrimaryAction:e,onSecondaryAction:t})=>{let[n,r]=(0,_.useState)(0),[i,a]=(0,_.useState)(`next`),[o,s]=(0,_.useState)(!0),[c,l]=(0,_.useState)(!1),[u,d]=(0,_.useState)({status:`idle`,lastUpdatedYear:``,lastPushDate:``}),f=(0,_.useRef)(null),p=(0,_.useRef)(null),m=(0,_.useRef)([]),h=(0,_.useRef)(null),g=(0,_.useRef)(null),v=(0,_.useRef)(null),y=vr(),b=$n.length,x=$n[n],S=!o||y,C=(0,_.useCallback)(()=>{a(`next`),r(e=>(e+1)%b)},[b]),w=(0,_.useCallback)(()=>{a(`previous`),r(e=>(e-1+b)%b)},[b]),ee=(0,_.useCallback)(e=>{if(e===n)return;let t=(e-n+b)%b,i=(n-e+b)%b;a(t<=i?`next`:`previous`),r(e)},[n,b]),te=()=>{l(!0),d(e=>e.status===`idle`?{...e,status:`loading`}:e)},ne=(0,_.useCallback)(()=>{l(!1),window.requestAnimationFrame(()=>{var e;(e=h.current)==null||e.focus()})},[]);return(0,_.useEffect)(()=>{$n.forEach(e=>{let t=new Image;t.src=e.image})},[]),(0,_.useEffect)(()=>{if(S||b<=1)return;let e=window.setTimeout(C,fr);return()=>{window.clearTimeout(e)}},[n,S,C,b]),(0,_.useEffect)(()=>{let e=p.current,t=m.current[n];if(!e||!t)return;let r=window.requestAnimationFrame(()=>{let n=e.getBoundingClientRect(),r=t.getBoundingClientRect(),i=r.top<n.top,a=r.bottom>n.bottom;if(!i&&!a)return;let o=0;i&&(o=r.top-n.top-8),a&&(o=r.bottom-n.bottom+8),e.scrollBy({top:o,behavior:y?`auto`:`smooth`})});return()=>{window.cancelAnimationFrame(r)}},[n,y]),(0,_.useEffect)(()=>{if(!c||u.status!==`loading`)return;let e=new AbortController;return fetch(er.repository.apiUrl,{signal:e.signal,headers:{Accept:`application/vnd.github+json`}}).then(e=>{if(!e.ok)throw Error(`Repository activity could not be loaded.`);return e.json()}).then(e=>{let t=_r(e.pushed_at,er.repository.timeZone);if(!t)throw Error(`Repository push date is unavailable.`);d({status:`success`,lastUpdatedYear:t.year,lastPushDate:t.formattedDate})}).catch(e=>{e.name!==`AbortError`&&d({status:`error`,lastUpdatedYear:``,lastPushDate:``})}),()=>{e.abort()}},[c,u.status]),(0,_.useEffect)(()=>{if(!c)return;let e=document.body.style.overflow,t=document.documentElement.style.overflow;document.body.style.overflow=`hidden`,document.documentElement.style.overflow=`hidden`;let n=window.requestAnimationFrame(()=>{var e;(e=v.current)==null||e.focus()}),r=e=>{if(e.key===`Escape`){e.preventDefault(),ne();return}if(e.key!==`Tab`)return;let t=g.current;if(!t)return;let n=Array.from(t.querySelectorAll(hr));if(n.length===0)return;let r=n[0],i=n[n.length-1];if(e.shiftKey&&document.activeElement===r){e.preventDefault(),i.focus();return}!e.shiftKey&&document.activeElement===i&&(e.preventDefault(),r.focus())};return window.addEventListener(`keydown`,r),()=>{window.cancelAnimationFrame(n),window.removeEventListener(`keydown`,r),document.body.style.overflow=e,document.documentElement.style.overflow=t}},[ne,c]),x?(0,M.jsxs)(j.Wrapper,{id:`cinematic-carousel`,className:`theme-${x.theme}`,"aria-label":`Featured cinematic stories`,"aria-roledescription":`carousel`,tabIndex:0,onKeyDown:e=>{e.target===e.currentTarget&&(e.key===`ArrowLeft`&&(e.preventDefault(),w()),e.key===`ArrowRight`&&(e.preventDefault(),C()),e.key===`Home`&&(e.preventDefault(),ee(0)),e.key===`End`&&(e.preventDefault(),ee(b-1)),e.key===` `&&(e.preventDefault(),s(e=>!e)))},children:[(0,M.jsxs)(j.Backgrounds,{"aria-hidden":`true`,children:[$n.map((e,t)=>{let r=[t===n?`is-active`:``,i===`previous`?`move-previous`:`move-next`].filter(Boolean).join(` `);return(0,M.jsx)(j.Background,{className:r,children:(0,M.jsx)(j.BackgroundImage,{src:e.image,alt:``,loading:t===0?`eager`:`lazy`})},e.id)}),(0,M.jsx)(j.BackgroundShade,{}),(0,M.jsx)(j.AmbientGlow,{}),(0,M.jsx)(j.Noise,{})]}),(0,M.jsxs)(j.Shell,{children:[(0,M.jsxs)(j.TopBar,{children:[(0,M.jsxs)(j.Brand,{ref:h,type:`button`,"aria-label":`Open developer details`,"aria-haspopup":`dialog`,"aria-expanded":c,onClick:te,children:[(0,M.jsx)(j.BrandMark,{"aria-hidden":`true`,children:(0,M.jsx)(`img`,{src:dr,alt:``})}),(0,M.jsxs)(j.BrandCopy,{children:[(0,M.jsx)(j.BrandName,{children:`Ashish Ranjan`}),(0,M.jsx)(j.BrandTagline,{children:`Full-Stack Developer`})]})]}),(0,M.jsxs)(j.AutoPlayButton,{type:`button`,className:o?`is-playing`:`is-paused`,"aria-pressed":o,"aria-label":o?`Pause automatic slide playback`:`Start automatic slide playback`,onClick:()=>{s(e=>!e)},children:[(0,M.jsx)(j.AutoPlayIcon,{"aria-hidden":`true`,children:o?`Ⅱ`:`▶`}),(0,M.jsx)(j.AutoPlayText,{children:o?`Playing`:`Paused`})]})]}),(0,M.jsx)(j.Main,{onPointerDown:e=>{var t,n;if((t=(n=e.target).closest)!=null&&t.call(n,mr)){f.current=null;return}f.current=e.clientX,e.currentTarget.setPointerCapture&&e.currentTarget.setPointerCapture(e.pointerId)},onPointerUp:e=>{var t,n;if(f.current===null)return;let r=e.clientX-f.current;if(f.current=null,(t=(n=e.currentTarget).hasPointerCapture)!=null&&t.call(n,e.pointerId)&&e.currentTarget.releasePointerCapture(e.pointerId),!(Math.abs(r)<pr)){if(r<0){C();return}w()}},onPointerCancel:e=>{var t,n;f.current=null,(t=(n=e.currentTarget).hasPointerCapture)!=null&&t.call(n,e.pointerId)&&e.currentTarget.releasePointerCapture(e.pointerId)},children:(0,M.jsxs)(j.Hero,{children:[(0,M.jsxs)(j.Content,{className:i===`previous`?`move-previous`:`move-next`,children:[(0,M.jsxs)(j.EyebrowRow,{children:[(0,M.jsx)(j.EyebrowLine,{}),(0,M.jsx)(j.Eyebrow,{children:x.eyebrow})]}),(0,M.jsxs)(j.Title,{children:[(0,M.jsx)(j.TitleLine,{children:x.title}),(0,M.jsx)(j.TitleAccent,{children:x.titleAccent})]}),(0,M.jsxs)(j.MetaList,{"aria-label":`Title information`,children:[(0,M.jsx)(j.MetaItem,{children:x.year}),(0,M.jsx)(j.MetaItem,{children:x.duration}),(0,M.jsx)(j.MetaItem,{children:x.rating}),(0,M.jsx)(j.MetaItem,{className:`is-highlighted`,children:x.quality})]}),(0,M.jsx)(j.Description,{children:x.description}),(0,M.jsx)(j.GenreList,{"aria-label":`Genres`,children:x.genres.map(e=>(0,M.jsx)(j.Genre,{children:e},e))}),(0,M.jsxs)(j.Actions,{children:[(0,M.jsxs)(j.PrimaryButton,{type:`button`,onClick:()=>{e==null||e(x)},children:[(0,M.jsx)(j.ButtonIcon,{"aria-hidden":`true`,children:`▶`}),x.primaryAction]}),(0,M.jsxs)(j.SecondaryButton,{type:`button`,onClick:()=>{t==null||t(x)},children:[x.secondaryAction,(0,M.jsx)(j.ButtonIcon,{"aria-hidden":`true`,children:`↗`})]})]})]},x.id),(0,M.jsxs)(j.PreviewRail,{id:`cinematic-previews`,children:[(0,M.jsxs)(j.PreviewHeader,{children:[(0,M.jsx)(j.PreviewLabel,{children:`All stories`}),(0,M.jsxs)(j.PreviewCount,{children:[String(n+1).padStart(2,`0`),(0,M.jsxs)(`span`,{children:[`/ `,String(b).padStart(2,`0`)]})]})]}),(0,M.jsx)(j.PreviewList,{ref:p,children:$n.map((e,t)=>(0,M.jsxs)(j.PreviewButton,{ref:e=>{m.current[t]=e},type:`button`,className:t===n?`is-active`:``,"aria-current":t===n?`true`:void 0,"aria-label":`Show ${e.title} ${e.titleAccent}`,onClick:()=>{ee(t)},children:[(0,M.jsx)(j.PreviewImage,{src:e.image,alt:``,loading:`lazy`}),(0,M.jsx)(j.PreviewOverlay,{}),(0,M.jsx)(j.PreviewIndex,{children:String(t+1).padStart(2,`0`)}),(0,M.jsxs)(j.PreviewContent,{children:[(0,M.jsx)(j.PreviewEyebrow,{children:t===n?`Now showing`:e.eyebrow}),(0,M.jsxs)(j.PreviewTitle,{children:[e.title,` `,e.titleAccent]})]})]},e.id))})]})]})}),(0,M.jsxs)(j.BottomBar,{children:[(0,M.jsx)(j.Pagination,{"aria-label":`Choose a slide`,children:$n.map((e,t)=>(0,M.jsx)(j.PaginationButton,{type:`button`,className:t===n?`is-active`:``,"aria-current":t===n?`true`:void 0,"aria-label":`Show slide ${t+1}: ${e.title} ${e.titleAccent}`,onClick:()=>{ee(t)},children:(0,M.jsx)(`span`,{})},e.id))}),(0,M.jsxs)(j.ProgressArea,{children:[(0,M.jsx)(j.ProgressLabel,{children:S?`Paused`:`Next story`}),(0,M.jsx)(j.ProgressTrack,{"aria-hidden":`true`,children:(0,M.jsx)(j.ProgressFill,{className:S?`is-paused`:``},`${n}-${S}`)})]}),(0,M.jsxs)(j.Navigation,{"aria-label":`Carousel navigation`,children:[(0,M.jsx)(j.NavButton,{type:`button`,"aria-label":`Show previous slide`,onClick:w,children:`←`}),(0,M.jsx)(j.NavButton,{type:`button`,"aria-label":`Show next slide`,onClick:C,children:`→`})]})]})]}),c&&(0,M.jsx)(j.DeveloperModalBackdrop,{onClick:e=>{e.target===e.currentTarget&&ne()},children:(0,M.jsxs)(j.DeveloperModal,{ref:g,role:`dialog`,"aria-modal":`true`,"aria-labelledby":`developer-modal-title`,"aria-describedby":`developer-modal-description`,children:[(0,M.jsxs)(j.DeveloperModalHeader,{children:[(0,M.jsxs)(j.DeveloperIdentity,{children:[(0,M.jsx)(j.DeveloperLogo,{children:(0,M.jsx)(`img`,{src:dr,alt:``})}),(0,M.jsxs)(j.DeveloperIntro,{children:[(0,M.jsx)(j.DeveloperKicker,{children:`Designed and developed by`}),(0,M.jsx)(j.DeveloperName,{id:`developer-modal-title`,children:er.name}),(0,M.jsx)(j.DeveloperRole,{children:er.role})]})]}),(0,M.jsx)(j.DeveloperCloseButton,{ref:v,type:`button`,"aria-label":`Close developer details`,onClick:ne,children:`×`})]}),(0,M.jsx)(j.DeveloperLocation,{children:er.location}),(0,M.jsx)(j.DeveloperDescription,{id:`developer-modal-description`,children:er.description}),(0,M.jsxs)(j.DeveloperRepositoryCard,{"aria-live":`polite`,children:[(0,M.jsxs)(j.DeveloperRepositoryHeader,{children:[(0,M.jsxs)(`div`,{children:[(0,M.jsx)(j.DeveloperRepositoryKicker,{children:`Repository activity`}),(0,M.jsx)(j.DeveloperRepositoryName,{children:er.repository.name})]}),(0,M.jsxs)(j.DeveloperRepositoryLink,{href:er.repository.url,target:`_blank`,rel:`noreferrer`,children:[`View repository`,(0,M.jsx)(`span`,{"aria-hidden":`true`,children:`↗`})]})]}),u.status===`loading`&&(0,M.jsx)(j.DeveloperRepositoryMessage,{children:`Loading latest repository activity...`}),u.status===`error`&&(0,M.jsx)(j.DeveloperRepositoryMessage,{children:`Repository activity is temporarily unavailable.`}),u.status===`success`&&(0,M.jsxs)(j.DeveloperRepositoryGrid,{children:[(0,M.jsxs)(j.DeveloperRepositoryItem,{children:[(0,M.jsx)(`span`,{children:`Last updated`}),(0,M.jsx)(`strong`,{children:u.lastUpdatedYear})]}),(0,M.jsxs)(j.DeveloperRepositoryItem,{children:[(0,M.jsx)(`span`,{children:`Last repository push`}),(0,M.jsx)(`strong`,{children:u.lastPushDate})]})]})]}),(0,M.jsx)(j.DeveloperLinks,{children:er.links.map(e=>(0,M.jsxs)(j.DeveloperLink,{href:e.url,target:`_blank`,rel:`noreferrer`,children:[(0,M.jsx)(`span`,{children:e.label}),(0,M.jsx)(`span`,{"aria-hidden":`true`,children:`↗`})]},e.id))}),(0,M.jsxs)(j.DeveloperFooter,{children:[`Cinematic Carousel UI`,(0,M.jsxs)(`span`,{children:[`© `,new Date().getFullYear()]})]})]})}),(0,M.jsxs)(j.LiveRegion,{"aria-live":`polite`,"aria-atomic":`true`,children:[`Slide `,n+1,` of `,b,`: `,x.title,` `,x.titleAccent]})]}):null};(0,v.createRoot)(document.getElementById(`root`)).render((0,M.jsx)(_.StrictMode,{children:(0,M.jsx)(()=>(0,M.jsx)(Qn.Wrapper,{children:(0,M.jsx)(yr,{})}),{})}));