...
`,j={Wrapper:A.section`
    ...
    `,Background:A.div`
        ...
        &.is-active.move-next {
            animation: ${ir} 1.3s cubic-bezier(0.16, 1, 0.3, 1)
                both;
        }
    ...
    `,BackgroundImage:A.img`
        ...
        animation: ${or} 18s ease-in-out alternate infinite;
    ...
    `,AmbientGlow:A.div`
        ...
        animation: ${cr} 8s ease-in-out infinite;
    `,Noise:A.div`
        position: absolute;
        inset: 0;
        opacity: 0.065;
    ...
    `,Content:A.div`
        ...
        &.move-next {
            animation: ${nr} 920ms cubic-bezier(0.16, 1, 0.3, 1)
                both;
        }
    ...
    `,DeveloperModal:A.div`
        ...
        isolation: isolate;
        animation: ${ur} 560ms cubic-bezier(0.16, 1, 0.3, 1) both;
